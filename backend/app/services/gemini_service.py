    ...
    async def stream_chat(self, message: str, history: List[Dict[str, str]] = None) -> AsyncGenerator[str, None]:
        ...
        if client and not settings.DEMO_MODE:
            try:
                ...
                - `package_type` (STRING): Shipping category / service tier (e.g. Standard Ground, Express Air, Overnight Priority, Freight Heavy, Same-Day Courier, International)
                ...
                3. Actionable business insights on package distribution and revenue optimization.
                """
